...
public class ManageEnchnantmentConfigScreen {
                ...
                .setSaveConsumer(list -> {
                    ...
                    for (String s : list) {
                        ...
                        if (parts.length == 2) {
                            ...
                            Exception e) {
                                ManageEnchnantment.LOGGER.error("Failed to parse material tier: {}", s);
                            }
                        }
                    }
                    ManageEnchnantment.LOGGER.info("Material tiers: {}", map);
